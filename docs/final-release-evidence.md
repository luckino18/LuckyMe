...
| Final signed APK artifact | `/Users/victor/Desktop/LuckyMe-Seeker-STORE-FINAL-v2-2026-07-08.apk` |
| Final APK SHA-256 | `c104ec372270dc175d54d26bf472edd9f489813324f66c9a6766df423fc05bc2` |
...
- The final v2 APK was built on 2026-07-08 with the `dapp-store` EAS profile.
- Final v2 removes the visible Settings/Configuration UI, uses Links for legal
  and community pages only, clarifies `95% prize / 3% jackpot / 2% treasury`,
  and resets the notification opt-in prompt key for this APK.
