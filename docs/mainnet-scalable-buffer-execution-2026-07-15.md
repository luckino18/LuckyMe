...
Status: buffer created, uploaded, and byte-verified. The program was not upgraded. The keeper and application remained online.
...
- Current authority: `9DvCoJTwdf8CcQUPiLBWEu5Zx4GiYCg8G7LwKaZtZbFc`.
...
The buffer authority has not yet been transferred to the Ledger authority. The final program upgrade has not been executed. Both are separate mainnet transactions and require their own explicit approvals.
